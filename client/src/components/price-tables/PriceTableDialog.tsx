  ...
  useEffect(() => {
    if (priceTable) {
      form.reset({
        ...
        currentPrice3x: priceTable.currentPrice3x,
        oldPrice3x: priceTable.oldPrice3x || "",
        currentPrice12x: priceTable.currentPrice12x,
        oldPrice12x: priceTable.oldPrice12x || "",
        months: priceTable.months || 3,
